...
apt-get update -y
apt-get install -y aria2 libsm6 libxext6 
apt-get install -y make build-essential libssl-dev zlib1g-dev libbz2-dev \
libreadline-dev libsqlite3-dev wget curl llvm libncurses5-dev libncursesw5-dev \
xz-utils tk-dev libxml2-dev libxmlsec1-dev libffi-dev liblzma-dev openssl git screen
...
then
    # 安装pyenv
    test -e $REAL_HOME/.pyenv && rm -rf $REAL_HOME/.pyenv
...
$REAL_HOME/.pyenv/bin/pyenv install 3.10.10
$REAL_HOME/.pyenv/bin/pyenv global 3.10.10
